                            ...
                            if (comment.id_comment == 0) {
                                return (
                                    <>
                                        ...
                                        {
                                            listComment.map(commentChild => {
                                                if (commentChild.id_comment == comment.id) {
                                                    return (
                                                        <li
                                                            key={commentChild.id}
                                                        ...
                                                        >
                                                            <button className="pull-left">
                                                                <img
                                                                    width="50px"
                                                                    className="media-object"
                                                                    src={`http://localhost/laravel/laravel/public/upload/user/avatar/${commentChild.image_user}`}
                                                                    alt=""
                                                                />
                                                            </button>
                                                            <div className="media-body">
                                                                <ul className="sinlge-post-meta">
                                                                    <li ><i className="fa fa-user" />{commentChild.name_user}</li>
                                                                    <li ><i className="fa fa-clock-o" /> {getHoursMinutesAMPM(commentChild.created_at)}</li>
                                                                    <li ><i className="fa fa-calendar" /> {getLongDate(commentChild.created_at)}</li>
                                                                </ul>
